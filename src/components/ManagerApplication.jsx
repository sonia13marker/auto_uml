              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                >
                  ...
                  <div className="flex flex-row gap-1">
                        ...
                        <p className="text-m text-gray-700">Иван {user.name}</p>
                    </div>
                    <div className="flex flex-row gap-1">
                        <h3 className="text-m font-medium text-gray-900">
                        Фамилия:
                        </h3>
                        <p className="text-m text-gray-700">Иванов {user.second_name}</p>
                    </div>
                  {/*данные машины */}
                  <div>
                    <h3 className="mb-3 text-xl font-semibold leading-9 tracking-tight text-gray-900">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex flex-row gap-1">
                        ...
                        <p className="text-m text-gray-700">Mazda 3{product.name}</p>
                      </div>
                      ...
                      <div className="flex flex-row gap-4">
                        <span className="flex flex-row gap-1">
                          ...
                          <p className="text-m text-gray-700">diesel {product.fuel}</p>
                        </span>
                        <span className="flex flex-row gap-1">
                          <h3 className="text-m font-medium text-gray-900">
                            л.:
